...
function showSlide(index) {
  ...
  if (!modal || !successTitle || !successText) return;
...
/* INSTALAR / AÑADIR A PANTALLA DE INICIO */
  ...
  installYes.addEventListener("click", async () => {
    ...
    if (deferredInstallPrompt) {
      ...
      successText.innerHTML =
        "En iPhone:<br><br>" +
        "1️⃣ Pulsa Compartir ⬆️<br>" +
        "2️⃣ Añadir a pantalla de inicio<br>" +
        "3️⃣ Pulsa Añadir";

    }

    installQuestion.style.display = "none";
    closeSuccess.style.display = "inline-block";
